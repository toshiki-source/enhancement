...
samples_dir = os.path.join("/home/toshiki/data_enhance/", dataset_name)
checkpoint_dir = os.path.join("/home/toshiki/data_enhance/", dataset_name)
print("samples_dir:",samples_dir)#/home/toshiki/data_enhance/Paired
print("checkpoint_dir:",checkpoint_dir)#/home/toshiki/data_enhance/Paired
...
for epoch in range(epoch, num_epochs):
    for i, batch in enumerate(dataloader):
        ...
        if batches_done % val_interval == 0:
            ...
            save_image(img_sample, "/home/toshiki/github/enhancement/FUnIE-GAN-master/PyTorch/samples/FunieGAN/%s/%s.png" % (dataset_name, batches_done), nrow=5, normalize=True)

    ## Save model checkpoints
    if (epoch % ckpt_interval == 0):
        torch.save(generator.state_dict(), "/home/toshiki/github/enhancement/FUnIE-GAN-master/PyTorch/samples/FunieGAN/%s/generator_%d.pth" % (dataset_name, epoch))
        print(dataset_name)#Paired
        print("/home/toshiki/github/enhancement/FUnIE-GAN-master/PyTorch/samples/FunieGAN/%s/generator_%d.pth" % (dataset_name, epoch))
        torch.save(discriminator.state_dict(), "/home/toshiki/github/enhancement/FUnIE-GAN-master/PyTorch/samples/FunieGAN/%s/discriminator_%d.pth" % (dataset_name, epoch))
